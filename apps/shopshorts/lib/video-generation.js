...
export async function videoInputFingerprint(job) {
  const source = canonical({ brief: job.brief, script: job.script, videoDirection: job.videoDirection, videoTier: job.videoTier ?? 'standard' });
