...
핵심 상황, 변화, 마무리가 있는 독창적인 이야기로 구성하세요. 목표 길이 ${brief.duration}초에 맞춰 장면 길이의 합계를 정확히 맞추고 내레이션도 각 장면 안에서 자연스럽게 읽을 수 있게 짧게 쓰세요. 화면 비율은 ${brief.aspect}입니다.
...
{"title":"영상 제목","scenes":[{"id":"scene-1","narration":"짧은 내레이션","prompt":"장면 설명","duration":6,"kind":"image"}]}`;
